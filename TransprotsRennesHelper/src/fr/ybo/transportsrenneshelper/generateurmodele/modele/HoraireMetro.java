...
public class HoraireMetro implements Serializable {
	...
	public Integer blo1;
	@BaliseCsv(value = "TRI1", adapter = AdapterTime.class)
	public Integer tri1;
	@BaliseCsv(value = "ITA1", adapter = AdapterTime.class)
	public Integer ita1;
	@BaliseCsv(value = "HFR1", adapter = AdapterTime.class)
	public Integer hfr1;
	@BaliseCsv(value = "GCL1", adapter = AdapterTime.class)
	public Integer gcl1;
	@BaliseCsv(value = "JCA1", adapter = AdapterTime.class)
	public Integer jca1;
	@BaliseCsv(value = "GAR1", adapter = AdapterTime.class)
	public Integer gar1;
	@BaliseCsv(value = "CDG1", adapter = AdapterTime.class)
	public Integer cdg1;
	@BaliseCsv(value = "REP1", adapter = AdapterTime.class)
	public Integer rep1;
	@BaliseCsv(value = "STA1", adapter = AdapterTime.class)
	public Integer sta1;
	@BaliseCsv(value = "ANF1", adapter = AdapterTime.class)
	public Integer anf1;
	@BaliseCsv(value = "PON1", adapter = AdapterTime.class)
	public Integer pon1;
	@BaliseCsv(value = "VU1", adapter = AdapterTime.class)
	public Integer vu1;
	@BaliseCsv(value = "JFK1", adapter = AdapterTime.class)
	public Integer jfk1;
	@BaliseCsv(value = "JFK2", adapter = AdapterTime.class)
	public Integer jfk2;
	@BaliseCsv(value = "VU2", adapter = AdapterTime.class)
	public Integer vu2;
	@BaliseCsv(value = "PON2", adapter = AdapterTime.class)
	public Integer pon2;
	@BaliseCsv(value = "ANF2", adapter = AdapterTime.class)
	public Integer anf2;
	@BaliseCsv(value = "STA2", adapter = AdapterTime.class)
	public Integer sta2;
	@BaliseCsv(value = "REP2", adapter = AdapterTime.class)
	public Integer rep2;
	@BaliseCsv(value = "CDG2", adapter = AdapterTime.class)
	public Integer cdg2;
	@BaliseCsv(value = "GAR2", adapter = AdapterTime.class)
	public Integer gar2;
	@BaliseCsv(value = "JCA2", adapter = AdapterTime.class)
	public Integer jca2;
	@BaliseCsv(value = "GCL2", adapter = AdapterTime.class)
	public Integer gcl2;
	@BaliseCsv(value = "HFR2", adapter = AdapterTime.class)
	public Integer hfr2;
	@BaliseCsv(value = "ITA2", adapter = AdapterTime.class)
	public Integer ita2;
	@BaliseCsv(value = "TRI2", adapter = AdapterTime.class)
	public Integer tri2;
	@BaliseCsv(value = "BLO2", adapter = AdapterTime.class)
	public Integer blo2;
	@BaliseCsv(value = "POT2", adapter = AdapterTime.class)
	public Integer pot2;
