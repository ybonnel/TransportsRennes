...
public class MapItemizedOverlayParking extends ItemizedOverlay<OverlayItem> {
    ...
    private final List<Parking> parkRelais = new ArrayList<Parking>(4);
    ...
    public void addOverlay(OverlayItem overlay, Parking parkRelai) {
    ...
    protected boolean onTap(final int index) {
        ...
        builder.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                dialog.dismiss();
                Parking parkRelai = parkRelais.get(index);
