...
public class Widget11UpdateUtil {
	...
	public static void updateAppWidget(Context context, RemoteViews views, ArretFavori favori, Calendar calendar) {
		...
		Intent intent = new Intent(context, TransportsWidget11.class);
		...
		try {
			List<Integer> prochainsDeparts = Horaire.getProchainHorairesAsList(favori.ligneId, favori.arretId, 2, calendar);
