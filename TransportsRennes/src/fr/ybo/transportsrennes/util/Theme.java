...
public enum Theme {
	NOIR(Color.LTGRAY, R.style.Theme_TransportsRennes_black, R.drawable.actionbar_compat_background_black),

	BLANC(Color.BLACK, R.style.Theme_TransportsRennes, R.drawable.actionbar_compat_background);
