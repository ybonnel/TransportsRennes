...
public class MetroStation implements Serializable {
	...
	/**
	 * @param pFloors the floors to set
	 */
	...
	/**
	 * @param pHasPlatformDirection1 the hasPlatformDirection1 to set
	 */
	...
	/**
	 * @param pHasPlatformDirection2 the hasPlatformDirection2 to set
	 */
	...
	/**
	 * @param pRankingPlatformDirection1 the rankingPlatformDirection1 to set
	 */
	...
	/**
	 * @param pRankingPlatformDirection2 the rankingPlatformDirection2 to set
	 */
