...
public class StationsFavorisShortcutPicker extends BaseSimpleActivity {
    ...
    private void setupShortcut() {
        ...
        final Parcelable shortcutIntent = new Intent(this, ListStationsFavoris.class);

        // Then, set up the container intent (the response to the caller)
        final Parcelable iconResource = Intent.ShortcutIconResource.fromContext(this, R.drawable.btn_velo_star_default);
        final Intent intent = new Intent().putExtra(Intent.EXTRA_SHORTCUT_INTENT, shortcutIntent).putExtra(Intent.EXTRA_SHORTCUT_NAME, getString(R.string.btn_velo_favori)).putExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE, iconResource);
